...
import { PieChart, PieChartOptions } from '@perses-dev/panels-plugin';
...
type PanelOptionsEditorWrapperProps = {
   ...
   */
  initialPanelDefinition: PanelDefinition<PieChartOptions>;
};

const PanelOptionsEditorWrapper = ({ initialPanelDefinition }: PanelOptionsEditorWrapperProps) => {
  const [panelDefinition, setPanelDefinition] = useState<PanelDefinition<PieChartOptions>>(initialPanelDefinition);

  function handleChange(newChartOptions: PieChartOptions) {
